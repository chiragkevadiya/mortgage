...
<html>
    <head>
        ...
        <style type="text/css">
            input[type=button]{appearance:button;backface-visibility:hidden;background-color:#405cf5;border-radius:6px;border-width:0;box-shadow:rgba(50, 50, 93, .1) 0 0 0 1px inset,rgba(50, 50, 93, .1) 0 2px 5px 0,rgba(0, 0, 0, .07) 0 1px 1px 0;box-sizing:border-box;color:#fff;cursor:pointer;font-family:inherit;font-size:100%;height:44px;line-height:1.15;outline:none;overflow:hidden;padding:0 25px;position:relative;text-align:center;text-transform:none;transform:translateZ(0);transition:all .2s,box-shadow .08s ease-in;user-select:none;-webkit-user-select:none;touch-action:manipulation;width:100%;}
            input[type=button]:disabled {cursor: default;}
            input[type=button]:focus {box-shadow: rgba(50, 50, 93, .1) 0 0 0 1px inset, rgba(50, 50, 93, .2) 0 6px 15px 0, rgba(0, 0, 0, .1) 0 2px 2px 0, rgba(50, 151, 211, .3) 0 0 0 4px;}
            #outlook a {padding:0;}
                    ...
                    <td valign="top" align="center">
                        ...
                        <table width="600" align="center" cellpadding="0" cellspacing="0" border="0" style="background-color: #FFF; border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                           <tr>
                              <td>
                                 <![endif]-->
                        <table cellpadding="0" cellspacing="0" border="0" align="center" style="width: 100%; max-width: 650px; background-color: #FFF; border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;" id="contentTable">
                            <tbody>
                                <tr>
                                    <td width="600" valign="top" align="center" style="border-collapse:collapse;">
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #E0E4E8;border-top: 10px solid #1c73fa;" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td align="center" style="padding: 28px 56px 28px 56px;" valign="top">
                                                        <a style="color: #3498DB; text-decoration: none;" href="<?php echo base_url() ?>" target="_blank"><img style="width: 84px; height: 84px; border: 0;" alt="Mortgage4U" src="<?php echo base_url('assets_admin/images/logo.png') ?>"></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" style="padding: 0 56px 28px 56px;text-align: center;" valign="top">
                                                        <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333; font-weight: bold;"><?php echo $email->subject ?></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" style="padding: 0 28px 28px 28px;" valign="top">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="center" style="padding: 28px 56px;" valign="top">
                                                        <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; line-height: 24px; color: #A7ADB5;"></div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
