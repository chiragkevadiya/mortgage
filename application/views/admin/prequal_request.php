...
<script type="text/javascript">
    ...
    function fetch_data(id)
    {
        ...
        $.ajax({
            type: "POST",
            url: '<?= site_url('admin/get_prequal_request/') ?>' + id,
                ...
                if (res.status)
                {
                    ...
                    for (var i = 0; i < length; i++)
                    {
                        ...
                        userdata += '<tr class="">' +
                                ...
                                '<td>' + holder[i].clientName + '</td>' +
                                '<td>' + holder[i].clientEmail + '</td>' +
                                '<td>' + holder[i].address + '</td>' +
                                '<td>' + holder[i].state + '</td>' +
                                '<td class="text-center">' + holder[i].purchasePrice + '</td>' +
                                '<td class="text-center">' + holder[i].downPmt + '</td>' +
                                '<td class="text-center">' + holder[i].downPmtPer + '</td>' +
                                '<td class="text-center">' + holder[i].loanAmt + '</td>' +
                                '<td class="text-center">' + holder[i].credit + '</td>' +
